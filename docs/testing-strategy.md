...
- Frontend Vitest smoke tests protect the React shell, routing, and gateway service integration seams.
...
- Frontend dependency restore, Vitest execution, and production build.
